...
import com.gorbich.devopsbuddy.backend.service.PlanService;
import com.gorbich.devopsbuddy.backend.service.S3Service;
...
import com.gorbich.devopsbuddy.exceptions.S3Exception;
import com.gorbich.devopsbuddy.exceptions.StripeException;
...
public class SignupController {
	...
	public String signUpPost(@RequestParam(name = "planId", required = true) int planId,
		...
		// There are certain info that the user doesn't set, such as profile
